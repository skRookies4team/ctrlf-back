...
import com.ctrlf.education.video.dto.VideoDtos.MaterialProcessRequest;
...
public interface VideoAiClient {
     ...
     */
    @PostMapping("/internal/ai/render-jobs")
    RenderJobResponse createRenderJob(
        @RequestBody RenderJobRequest request
    );
}
